...
REPLY_CHOICE_TEXT = (
    "Введите текст сообщением (NO/EN) или выберите пресет / HTML.\n\n"
    "<i>HTML: прокси + Aqua-ссылка. Тема и <code>{{NICK}}</code> — из "
    "⚙️ → 👤 Имя для спуфинга; From — из добавленной почты.</i>\n"
