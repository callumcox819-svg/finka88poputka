...
WELCOME = (
    "👋 Привет! <b>Poputka88 Finland</b> — рассылка по email для <b>Tori.fi</b>.\n\n"
    "Основные команды:\n"
    "/send — рассылка (после /reset только новые лиды)\n"
    "/sendall — рассылка по всей БД\n"
    "/stop — остановить рассылку\n"
    "/stat — статус рассылки\n"
    "/reset — очистить очередь рассылки (лиды в БД остаются)\n"
